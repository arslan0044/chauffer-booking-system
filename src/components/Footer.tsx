...
export default function Footer({Name,email}:{Name:String,email:String}) {
  const Links = [
    { name: "HOME", link: "/" },
  ...
  const Social = [
    ...
    },
    {
      name: "Youtube",
      icons: <Youtube />,
      link: "https://youtube.cmom/@CitiSolution",
    },
    {
      name: "Youtube",
      icons: <LinkedinIcon />,
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            {Social.map((i, index) => (
              <Link
                ...
                href={i.link}
                target="_blank"
                className="text-gray-500 hover:text-[#010203] mx-3 dark:hover:text-[#fafaf5]"
              >
                {i.icons}
